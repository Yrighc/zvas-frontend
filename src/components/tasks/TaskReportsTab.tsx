    ...
    <div className="flex flex-col gap-6 animate-in fade-in duration-500 w-full mb-8">
      <div className="flex flex-col xl:flex-row items-start xl:items-center justify-between w-full gap-4">
        <div className="flex flex-col">
          ...
          <p className="text-[13px] text-apple-text-tertiary font-medium">导出当前任务的漏洞扫描 Word 报告、Excel 清单和 HTML 报告，并查看导出历史。</p>
          ...
          >
            {items.map((it) => (
              <TableRow key={it.id}>
                ...
                <TableCell>
                  <MonoCell value={it.scope_id} limit={28} className="text-white" />
                </TableCell>
                <TableCell>
