      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-apple-bg border border-apple-blue-light/30">
          <CardBody className="p-6 flex flex-col">
            <span className="text-sm text-apple-text-secondary mb-2 uppercase tracking-wider font-semibold">版本</span>
        ...
        <Card className="bg-apple-bg border border-apple-border">
          <CardBody className="p-6 flex flex-col">
            <span className="text-sm text-apple-text-secondary mb-2 uppercase tracking-wider font-semibold">提交记录</span>
            <strong className="text-sm font-mono truncate text-apple-text-primary">{versionQuery.data.commit}</strong>
          </CardBody>
        </Card>
        <Card className="bg-apple-bg border border-apple-border">
          <CardBody className="p-6 flex flex-col">
            <span className="text-sm text-apple-text-secondary mb-2 uppercase tracking-wider font-semibold">构建时间</span>
      ...
      <Card className="bg-apple-black border border-apple-border">
        <CardBody className="p-6">
          ...
          <div className="grid grid-cols-[140px_1fr] gap-y-4 text-sm font-medium">
            <div className="text-apple-text-secondary">服务</div>
