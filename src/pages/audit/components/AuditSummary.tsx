        ...
        <section className="grid grid-cols-1 md:grid-cols-4 gap-6 h-auto md:h-[130px]">
            ...
            <Card className="bg-apple-tertiary-bg/5 border border-white/5 backdrop-blur-3xl h-full shadow-none apple-spotlight rounded-[32px]">
                <CardBody className="p-6 flex flex-col justify-center">
                    <span className="text-[11px] text-apple-text-tertiary font-semibold mb-0.5">审计总量</span>
                    <span className="text-[9px] text-apple-blue-light uppercase tracking-[0.25em] font-black opacity-60">Full_Access_Log</span>
            ...
            <Card className="bg-apple-tertiary-bg/5 border border-white/5 backdrop-blur-3xl h-full shadow-none apple-spotlight rounded-[32px]">
                <CardBody className="p-6 flex flex-col justify-center">
                    <span className="text-[11px] text-apple-text-tertiary font-semibold mb-0.5">高风险告警</span>
                    <span className="text-[9px] text-apple-red-light uppercase tracking-[0.25em] font-black opacity-60 mb-1">Critical_Alert</span>
            ...
            <Card className="bg-apple-tertiary-bg/5 border border-white/5 backdrop-blur-3xl h-full shadow-none apple-spotlight rounded-[32px]">
                <CardBody className="p-6 flex flex-col justify-center">
                    <span className="text-[11px] text-apple-text-tertiary font-semibold mb-0.5">执行失败</span>
                    <span className="text-[9px] text-apple-text-tertiary uppercase tracking-[0.25em] font-black opacity-60 mb-1">Execution_Fail</span>
            ...
            <Card className="bg-apple-tertiary-bg/5 border border-white/5 backdrop-blur-3xl h-full shadow-none apple-spotlight rounded-[32px]">
                <CardBody className="p-6 flex flex-col justify-center">
                    <span className="text-[11px] text-apple-text-tertiary font-semibold mb-0.5">操作主体</span>
                    <span className="text-[9px] text-apple-blue-light uppercase tracking-[0.25em] font-black opacity-60 mb-1">Mirror_Actors</span>
